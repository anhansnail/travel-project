...
class VietNamInfoOptionConversation extends Conversation
{
    /**
     * First question
     */
    ...
    {
        $question = Question::create("Welcome my dear come to Minh Anh chatbot , and what do you want to ask Viet Nam??")
