            ...
            <div class="container">
                ...
                <div class="testimonial-wrapper">
                    <div class="row">
                        ...
                        <!-- Testimonials-four-close -->
                        <!-- Testimonials-five-start -->
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="testimonial-block">
                                <div class="testimonial-img"><img src="images/testimonial-img-5.jpg" alt=""></div>
                                <div class="testimonial-user-img"><img src="images/testimonial-user-img-5.jpg" alt="Tour and Travel Agency - Responsive Website Template" class="img-circle"></div>
                                <div class="testimonial-content">
                                    <h4>Andrea Nowell</h4>
                                    <span class="location">Kuchh-bhuj</span>
                                    <div class="rating"> <span> <i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> </div>
                                    <div>
                                        <p class="testimonial-text">"Donec egestas pulvinar sapien is ornare ligula just in hendrerit massa placerat velliquam kuchh-bhuj aliquet, thank you" </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- Testimonials-five-close -->
                        <!-- Testimonials-six-start -->
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="testimonial-block">
                                <div class="testimonial-img"><img src="images/testimonial-img-6.jpg" alt=""></div>
                                <div class="testimonial-user-img"><img src="images/testimonial-user-img-6.jpg" alt="Tour and Travel Agency - Responsive Website Template" class="img-circle"></div>
                                <div class="testimonial-content">
                                    <h4>Christine Smith</h4>
                                    <span class="location">Greece</span>
                                    <div class="rating"> <span> <i class="fa fa-star"></i></span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> <span><i class="fa fa-star"></i> </span> </div>
                                    <div>
                                        <p class="testimonial-text">"Posuere vellacus Greece cipitvene natis ante liquam et nulla arcu aliquam vitae est mattisam interdum mollis felis, thank you ”</p>
                                    </div>
                                </div>
                            </div>
                        </div>
