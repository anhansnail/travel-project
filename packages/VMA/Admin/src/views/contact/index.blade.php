            ...
            <div class="panel-body">
                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        <thead>
                        <tr>
                                    <th>id</th>        <th>email</th>        <th>phone</th>        <th>content</th>        <th>created_at</th>        <th>updated_at</th>
                            <th>Action</th>
                        ...
                        <?php foreach($records as $record){ ?>
                            <tr>
                                         <td>{{$record->id}}</td>         <td>{{$record->email}}</td>         <td>{{$record->phone}}</td>         <td>{{$record->content}}</td>         <td>{{$record->created_at}}</td>         <td>{{$record->updated_at}}</td>
